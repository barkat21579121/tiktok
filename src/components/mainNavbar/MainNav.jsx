...
const MainNav = () => {
    ...
    return (<>      <div className="navbar-container" style={{position:'fixed'}}>
        ...
        <div className='sideBar' style={{ width: '300px', maxHeight: '800px', marginTop: '-150px' }}>
            <div style={{ display: 'flex',background:"bisque" }} ><IoMdHome style={{ width: '50px', cursor: 'pointer', height: 'auto' }} />
            ...
            <input value="new" className='newinput' />
            <div style={{ display: 'flex' }}><Link to='profile'> <IoIosPerson style={{ width: '50px',marginTop:'19px', cursor: 'pointer',
             height: 'auto' }} /></Link>
